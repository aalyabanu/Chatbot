            ...
            <div className="col-span-1 my-6 mx-4  bg-indigo-700 min-h-full text-white rounded px-4 py-4 ">
                ...
                {cardInfo.filter(card => card.tag === mychoice).map(filteredInfo => (
                    <div key={filteredInfo.tag}>
                        ...
                        <button className="bg-white hover:bg-orange-500 text-orange-700 float-right hover:text-white py-2 px-4 border border-orange-500 hover:border-transparent rounded center">Talk to MoodBot about it.</button>
